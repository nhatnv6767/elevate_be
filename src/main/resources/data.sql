...
-- Insert users
INSERT INTO public.users (id, username, password, full_name, email, phone, date_of_birth, identity_number, status,
                          created_at, updated_at, version)
VALUES ('u1', 'admin1', '$2a$10$rPiEAgSK4ANCa8RxMNM8T.LqsGk.czPCa7OXoicX7CsWqHxQxwh1O', 'Admin User', 'admin@bank.com',
        '0901234567', '1990-01-01', '123456789012', 'ACTIVE', NOW(), NOW(), 0),
       ('u2', 'customer1', '$2a$10$rPiEAgSK4ANCa8RxMNM8T.LqsGk.czPCa7OXoicX7CsWqHxQxwh1O', 'John Doe',
        'john@example.com', '0901234568', '1992-03-15', '123456789013', 'ACTIVE', NOW(), NOW(), 0),
       ('u3', 'customer2', '$2a$10$rPiEAgSK4ANCa8RxMNM8T.LqsGk.czPCa7OXoicX7CsWqHxQxwh1O', 'Jane Smith',
        'jane@example.com', '0901234569', '1995-07-20', '123456789014', 'ACTIVE', NOW(), NOW(), 0),
       ('u4', 'staff1', '$2a$10$rPiEAgSK4ANCa8RxMNM8T.LqsGk.czPCa7OXoicX7CsWqHxQxwh1O', 'Staff One', 'staff1@bank.com',
        '0901234570', '1988-12-10', '123456789015', 'ACTIVE', NOW(), NOW(), 0);
...
-- Insert accounts
INSERT INTO public.accounts (id, user_id, account_number, balance, status, created_at, updated_at, version)
VALUES ('a1', 'u2', '0012024030100001', 1000000.00, 'ACTIVE', NOW(), NOW(), 0),
...
INSERT INTO public.transactions (transaction_id,
                                 from_account_id,
                                 to_account_id,
                                 amount,
                                 transaction_type,
                                 ...
                                 created_at,
                                 updated_at)
VALUES ('t1', 'a1', 'a3', 100000.00, 'TRANSFER', 'COMPLETED', 'Chuyển tiền học phí', NOW(), NOW()),
...
INSERT INTO public.transactions (transaction_id,
                                 ...
                                 created_at,
                                 updated_at)
VALUES ('t6', 'a1', 1000000.00, 'DEPOSIT', 'COMPLETED', 'Nạp tiền ATM', NOW(), NOW()),
...
INSERT INTO public.transactions (transaction_id,
                                 ...
                                 created_at,
                                 updated_at)
VALUES ('t9', 'a1', 500000.00, 'WITHDRAWAL', 'COMPLETED', 'Rút tiền ATM', NOW(), NOW()),
...
INSERT INTO public.loyalty_points (id,
                                   user_id,
                                   total_points,
                                   points_earned,
                                   points_spent,
                                   ...
                                   updated_at,
                                   version)
VALUES ('lp1', 'u1', 1000, 1200, 200, 'SILVER', NOW(), NOW(), 0),
...
INSERT INTO public.point_transactions (transaction_id,
                                       user_id,
                                       points,
                                       transaction_type,
                                       description,
                                       created_at)
VALUES ('pt1', 'u1', 100, 'EARNED', 'Welcome bonus', NOW()),
